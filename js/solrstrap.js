...
var SERVERROOT = 'http://localhost:8983/solr/EMIData/select'
var HITTITLE = 'Des';                                        //Name of the title field- the heading of each hit
var HITBODY = 'text';                                          //Name of the body field- the teaser text of each hit
var HITSPERPAGE = 20;                        //page size- hits per page
var FACETS = ['Cat','Manu'];                       //facet categories

var FACETS_TITLES = {'Cat': 'Categories', 'Manu': 'Manufacturer'};  // selective rename facet names for display

var HITID = 'id'		// Name of the id field
var HITTEASER = 'Des';	// Name of field to use for teaser
var HITLINK = 'RepURL';		// Name of field to use for link
